...
samplesfile = loadmat('archive/eeg_raw_data/1/10_20151014.mat')
...
data = loadmat('archive/eeg_raw_data/1/10_20151014.mat')
info = mne.create_info(ch_names,sfreq)
raw = mne.io.RawArray(samples,info)
# mne.filter.filter_data(raw,sfreq,1,75)
raw_new = raw.copy().filter(1,75,'all')
# raw.save("archive/eeg_raw_data/1/10_20151014.fif")
raw_new.plot()
